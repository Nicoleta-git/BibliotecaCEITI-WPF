...
| Кто | Над чем работал |
| --- | --- |
| [@Nicoleta-git](https://github.com/Nicoleta-git) | Автор проекта. Интерфейс и темы, графики на панели, страницы учеников, бронирование книг, настройки, помощник Gemini, перевод на английский/румынский/русский, структура проекта, установщик, страница загрузки и CI |
| [@Misha-cybernet](https://github.com/Misha-cybernet) | Скрипты базы данных, сценарий выдачи книг и четыре шага мастера, CRUD по ученикам, экземпляры и архивирование, поиск книг, загрузка обложек, генератор QR-кодов, обработка ошибок и сбоев |
| [@00NYXth](https://github.com/00NYXth) | Вход через Google OAuth, уведомления по электронной почте, предупреждающие уведомления, панель настроек базы данных, выход из аккаунта |
| valentin_0x | Элемент ручной выдачи книг и его подключение к странице выдач |
